mcp-remote
0.1.29 • Public • Published 2 months ago
mcp-remote
...
https://github.com/cloudflare/agents/tree/main/examples/mcp for defining an McpAgent using the agents framework.
...
Homepage
github.com/geelen/mcp-remote#readme