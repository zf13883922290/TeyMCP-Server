mcp-linux-x64
2.0.0-beta.1 • Public • Published 6 days ago
Microsoft Azure Logo Azure MCP Server NPM Package
...
%APPDATA%\Claude\claude_desktop_config.json (Windows)	Claude Desktop MCP Setup
...
settings.json (user)	VS Code MCP Documentation
...
Homepage
github.com/Microsoft/mcp/blob/main/servers/Azure.Mcp.Server#readme